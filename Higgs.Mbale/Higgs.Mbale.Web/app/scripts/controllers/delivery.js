...
angular
    ...
    function ($scope, $http, $filter, $location, $log, $timeout, $state,usSpinnerService) {
        ...
        $scope.downloadPDF = function () {
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    [
                                        ...
                                        { text: 'Mbale investment and Grain millers', style: 'topHeader', alignment: 'center' },
                ...
                content: [
                    {
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    {
                                        text: 'Delivery  Details  of ' + ' ' + $scope.delivery.CustomerName + '   with Order Number  ' + $scope.delivery.OrderId,
                                        style: 'tableHeader', colSpan: 2, alignment: 'center'
                                    },
                                    {}
                                ],
                                [
                                    { text: 'CUSTOMER NAME ', style: 'tableLabel', bold: true }, { text: $scope.delivery.CustomerName },

                                ],
                                [
                                    { text: 'ORDER NUMBER ', style: 'tableLabel', bold: true }, { text: $scope.delivery.OrderId.toString() },
                                ],
                                [
                                    { text: 'VEHICLE NUMBER ', style: 'tableLabel', bold: true }, { text: $scope.delivery.VehicleNumber },
                                ],
                                [
                                    { text: 'DRIVER NAME ', style: 'tableLabel', bold: true }, { text: $scope.delivery.DriverName },
                                ],
                                
                                [
                                    { text: 'PRODUCT', style: 'tableLabel', bold: true }, { text: $scope.delivery.ProductName },
                                ],
                                [
                                    { text: 'BRANCH ', style: 'tableLabel', bold: true }, { text: $scope.delivery.BranchName },
                                ],
                                
                                
                                [
                                    { text: 'TOTAL QUANTITY ', style: 'tableLabel', bold: true }, { text: $scope.delivery.Quantity.toString() },
                                ],
                                [
                                    { text: 'DELIVERED TO', style: 'tableLabel', bold: true }, { text: $scope.delivery.Location },
                                ],
                                [
                                    { text: 'GRADE', style: 'tableLabel', bold: true },
                                    {
                                        style: 'table',
                                        table: {
                                            widths: ['*', '*', '*'],
                                            ...
                                            body: [
                                                [
                                                    {
                                                        text: 'Delivered  Grade  ' + ' ' + $scope.delivery.CustomerName + '   with Order Number  ' + $scope.delivery.OrderId,
                                                ...
                                                [
                                                    ...
                                                    { text: 'VALUE', bold: true }, { text: 'PRICE', bold: true } ,{ text: 'QUANTITY', bold: true }
                                                ],
            ...
            pdfMake.createPdf(docDefinition).download("DeliveryDetail.pdf");
        };
