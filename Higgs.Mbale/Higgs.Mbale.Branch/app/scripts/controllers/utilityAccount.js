                ...
                promise.then(
                    function (payload) {
                        ...
                        $timeout(function () {
                            ...
                            if (action == "create") {
                                $state.go('category-utility-view', {'categoryId': utilityAccount.UtilityCategoryId});
                            }
...
angular
    .module('homer').controller('UtilityAccountCategoryController', ['$scope', 'ngTableParams', '$http', '$filter', '$location', 'Utils', 'uiGridConstants',
        function ($scope, ngTableParams, $http, $filter, $location, Utils, uiGridConstants) {
            ...
            var promise = $http.get('/webapi/UtilityAccountApi/GetLatestTwentyUtilityAccountsForAParticularBranchAndCategory?categoryId=' + categoryId, {});
            promise.then(
                function (payload) {
