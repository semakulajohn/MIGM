...
angular
    .module('homer').controller('StoreBuveraTransferController', ['$scope', 'ngTableParams', '$http', '$filter', '$location', 'Utils', 'uiGridConstants',
        function ($scope, ngTableParams, $http, $filter, $location, Utils, uiGridConstants) {
            ...
            var promise = $http.get('/webapi/BuveraTransferApi/GetAllBuveraTransfersForAparticularStore');
            promise.then(
                function (payload) {
...
angular
    ...
    function ($scope, $http, $filter, $location, $log, $timeout, $modal, $state, uiGridConstants, $interval) {
        ...
        var promise = $http.get('/webapi/BuveraTransferApi/GetStoreBuveraTransferStock');
        promise.then(
            function (payload) {
                var b = payload.data;
